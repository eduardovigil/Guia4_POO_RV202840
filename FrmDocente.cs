...
namespace Guia4_POO_RV22840
{
    public partial class FrmDocente : Form
    {
        ...
        private List<Docente> registros = new List<Docente>();
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            maestro.Usuario = txtusuario.Text;
            maestro.Codigo = txtcodigo.Text;
            maestro.Materia = txtmateria.Text;

            if (edit_indice > -1) //verifica si hay un índice seleccionado
            {
                registros[edit_indice] = maestro;
                edit_indice = -1;
            }
            else
            {

                registros.Add(maestro); /*al arreglo de Productos le agrego el objeto creado con todos los datos que recolecté*/
